      ...
      <main>
        ...
        <section className="border-t-2 border-gold/40 py-16 bg-[#0c0c0c]">
          <div className="w-[min(100%-48px,1200px)] mx-auto">
            ...
            {/* FAIXA BRANCA — entra deslizando da esquerda ao scroll */}
            <Reveal>
              <div className="mt-10 -mx-6 overflow-hidden">
                <div
                  className="bg-white py-5 px-10 flex items-center justify-center gap-0 flex-wrap"
                  style={{ transition: 'transform 0.9s cubic-bezier(0.22,1,0.36,1)' }}
                >
                  <span className="text-[.62rem] font-black uppercase tracking-[.2em] text-black/30 pr-6 border-r border-black/10 mr-1">
                    Editoras
                  </span>
                  {editoras.map((e, i) => (
                    <span key={e} className="font-display text-[clamp(1rem,2vw,1.4rem)] font-semibold text-black/80 px-6 border-r border-black/10 last:border-0">
                      {e}
                    </span>
                  ))}
                  <span className="font-display text-[clamp(1rem,2vw,1.4rem)] font-semibold text-black/50 px-6 italic">
                    ABRAMUS <span className="text-[.7em] not-italic text-black/30 ml-1">gestão coletiva</span>
                  </span>
                </div>
              </div>
            </Reveal>
